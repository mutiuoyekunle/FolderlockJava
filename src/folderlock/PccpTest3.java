...
import static folderlock.PccpTest4.pccpTest4;
import java.io.File;
 ...
 * @author omobamhuteew
 */
public class PccpTest3 extends javax.swing.JFrame {
    ...
    public static PccpTest3 pccpTest3 = new PccpTest3();
    /**
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Select coordinate in image 3 0f 5:");

        jPanel2.setToolTipText("");
        jPanel2.setMaximumSize(new java.awt.Dimension(600, 500));
        jPanel2.setPreferredSize(new java.awt.Dimension(600, 500));

        image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/folderlock/imageV/Capture.JPG"))); // NOI18N
        image.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                PccpTest3.this.mouseClicked(evt);
            }
        });
...
//        xAxis.setText(array1.toJSONString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PccpTest3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
