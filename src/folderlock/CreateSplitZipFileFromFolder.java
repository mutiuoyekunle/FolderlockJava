...
public class CreateSplitZipFileFromFolder {
	...
	public CreateSplitZipFileFromFolder(String folderLoc, String zipLoc) {
		...
		try {
			...
			// exception
			zipFile.createZipFileFromFolder(folderLoc, parameters, true, 10485760);
	...
	public static void main(String[] args) {
		new CreateSplitZipFileFromFolder("C:\\ZipTest","ZipTest\\CreateSplitZipFileFromFolder.zip");
	}
