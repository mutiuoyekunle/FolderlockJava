...
import static folderlock.UnlockFolder.folderPath;
import static folderlock.pccpUnlock.PccpTest2.pccpTest2;
 ...
 * @author omobamhuteew
 */
public class PccpTest extends javax.swing.JFrame {
    ...
    public static JSONArray array1 = new JSONArray();
    public static PccpTest pccpTest1 = new PccpTest();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Select coordinate in image 1 0f 5:");

        jPanel2.setToolTipText("");
        jPanel2.setMaximumSize(new java.awt.Dimension(600, 500));
        jPanel2.setPreferredSize(new java.awt.Dimension(600, 500));

        image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/folderlock/imageV/stock-vector-vintage-template-with-camera-design-105929174.jpg"))); // NOI18N
        image.setPreferredSize(new java.awt.Dimension(600, 500));
        image.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                PccpTest.this.mouseClicked(evt);
            }
        });
...
//        String fileName = "appMetaData/appInfo/mayAffectApp/children/a.json";
//        String cont = "a:"+x+"."+y;
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PccpTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
